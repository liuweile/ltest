...
import com.alxad.oaid.interfaces.AlxHWIDInterface;
...
public class HWDeviceIDHelper {
  ...
  public void getHWID(AlxDevicesIDsHelper.AppIdsUpdater _listener) {
    try {
    ...
    if (isBin) {
      try {
        ...
        AlxHWIDInterface.HWID hwID = new AlxHWIDInterface.HWID(iBinder);
