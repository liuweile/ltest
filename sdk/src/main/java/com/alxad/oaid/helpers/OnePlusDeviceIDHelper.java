...
import com.alxad.oaid.interfaces.AlxOnePlusIDInterface;
...
public class OnePlusDeviceIDHelper {
    ...
    private String sign;
    AlxOnePlusIDInterface onePlusIDInterface;
...
//        String aaid = realoGetIds("AUID");
    ...
    private String realoGetIds(String str) {
        try {
            ...
            res = ((AlxOnePlusIDInterface.up.down) onePlusIDInterface).getSerID(pkgName, sign, str);
            return res;
        } catch (Exception e) {
            e.printStackTrace();
            return "";
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            onePlusIDInterface = AlxOnePlusIDInterface.up.genInterface(service);
        }
