...
import com.alxad.oaid.interfaces.AlxASUSIDInterface;
...
public class ASUSDeviceIDHelper {
   ...
   * @param _listener
   */
  public void getID(AlxDevicesIDsHelper.AppIdsUpdater _listener) {
    try {
    ...
    if (isBin) {
      try {
        ...
        AlxASUSIDInterface.ASUSID asusID = new AlxASUSIDInterface.ASUSID(iBinder);
