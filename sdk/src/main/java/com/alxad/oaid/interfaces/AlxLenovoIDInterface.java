 ...
 ****************************
 */
public interface AlxLenovoIDInterface extends IInterface {
  ...
  public abstract class len_up extends Binder implements AlxLenovoIDInterface {

    public static class len_down implements AlxLenovoIDInterface {
    ...
    public static AlxLenovoIDInterface getHelper(IBinder iBinder) {
      if (iBinder == null) {
        return null;
      }
      IInterface iInterface = iBinder.queryLocalInterface("com.zui.deviceidservice.IDeviceidInterface");
      if (iInterface == null || !(iInterface instanceof AlxLenovoIDInterface)) {
        return new len_down(iBinder);
      }
      else {
        return (AlxLenovoIDInterface) iInterface;
      }
    }
  }
}
