...
public interface AlxZTEIDInterface extends IInterface {
  boolean c();
  String getOAID();
  boolean isSupported();
  void shutDown();

  public static abstract class up extends Binder implements AlxZTEIDInterface {
    public static class down implements AlxZTEIDInterface {
