...
public class AlxGifDrawable extends Drawable implements Runnable, Animatable {
    ...
    public AlxGifDrawable(Movie movie, int byteCount) {
        this.movie = movie;
