...
public class AlxTextureView extends TextureView {
    protected final String TAG = AlxTextureView.class.getSimpleName();
    ...
    public int VIDEO_IMAGE_DISPLAY_TYPE = 0;

    public AlxTextureView(Context context) {
        super(context);
        currentVideoWidth = 0;
        currentVideoHeight = 0;
    }

    public AlxTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        currentVideoWidth = 0;
        currentVideoHeight = 0;
    }
