...
//                mResponse.adItem = ads;
    ...
    private void handleHtml(AlxInterstitialUIData uiData, AlxAdItemBean ads) throws Exception {
        if (ads != null) {
            String html = ads.adm;
